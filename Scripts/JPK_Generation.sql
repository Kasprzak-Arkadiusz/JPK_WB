...
DECLARE
    ...
    WHILE (@@FETCH_STATUS = 0)
        BEGIN
            INSERT INTO #SelectedRow (NumerWiersza, DataOperacji, NazwaPodmiotu, OpisOperacji, KwotaOperacji,
                                      SaldoOperacji)
...
select @xml =
       (SELECT (SELECT N'1-0'        AS [tns:KodFormularza/@wersjaSchemy]
               ...
               (SELECT (SELECT p.NIP   AS [etd:NIP]
